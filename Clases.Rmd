...
Los datos se producen con base en métodos científicos y buenas prácticas. La escritura es la forma más común de comunicación científica, pero los científicos tienen fama de ser malos escritores. ¿Por qué? Una posible razón es que nunca se les enseña realmente a escribir. Escribir con claridad tiene beneficios: facilita la colaboración y reduce la brecha entre la academia y la sociedad.  

#### ¿Cómo usar este recurso?  
El **Scientific Writing Resource** es un curso en línea diseñado para enseñar a escribir de manera efectiva. No se centra en la corrección gramatical o de puntuación, sino en comunicar claramente la intención del autor. Aunque está en inglés y está dirigido a estudiantes de posgrado en ciencias, puede traducirse y utilizarse de manera autodidacta.  
...
El objetivo de la escritura es la comunicación. Estas lecciones no establecen reglas absolutas, sino principios basados en la perspectiva del lector. Se inspiran en las ideas de Joseph Williams y George Gopen, quienes sostienen que, si comprendes lo que los lectores esperan, puedes cumplir con esas expectativas y mejorar tu comunicación escrita.  
