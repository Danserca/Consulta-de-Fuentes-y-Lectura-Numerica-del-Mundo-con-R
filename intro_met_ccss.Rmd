...
| **Análisis**       |                 |        |
| _Criterios_        | Exactitud (validez, precisión, incertidumbre, validez externa); Instrumento: muestreo (representatividad, tamaño, nivel de análisis); acumulación (estandarización, replicación, transparencia); ajuste teórico (validez de constructo, severidad, predictivo) | 4.1       |

---
|        **II. DESCRIPCIÓN**            |
|-------------------- |-----------|
| **Conceptos**       |           |
| _Criterios_       | Resonancia; dominio; consistencia; fertilidad; diferenciación; utilidad causal; operacionalización; amplitud definitoria (mínima, máxima, univocidad) |
| _Estrategias_     | Investigación de conceptos; clasificación de atributos; definición (mínima, máxima, acumulativa) |
| **Mediciones**      |           |
| _Criterios_       | Fiabilidad (precisión); validez |
| _Estrategias_     | Niveles de abstracción (alto, medio, bajo); estructura de teoría (conceptual, operacional); aproximaciones (formal, global, instrumental, crítica, dinámica); conjuntos agregados; índices (información, aglutinación); matriz conceptual; análisis (clasificación, simplificación, construcción, interpretación) |
...
|---------------------|-----------|
| **Argumentos**      |           |
| _Criterios_       | Claridad, manipulabilidad; agresión; independencia; impacto; mecanismo causal |
| **Análisis**        |           |
| _Criterios_       | Traslación (exogenidad, variación, simplicidad, dimensionalidad, discriminación, distribución uniforme, fuerza, proximidad, conexión); mezcla; yuxtaposición; matices (moderatización, operalización) |
