...
Nos reunimos una vez por semana en un laboratorio de computación. Cada clase implicará una pequeña cantidad de conferencias sobre conceptos de R y una gran cantidad de tiempo para que los estudiantes completen problemas de codificación y análisis asignados semanalmente. Al completar las tareas, los estudiantes crearán un portafolio de codificación que demuestre una variedad de habilidades de comunicación y análisis de datos. El proceso de aprender a codificar requiere paciencia, tiempo y práctica. Se espera que los estudiantes practiquen la codificación fuera del horario de clase cada semana.
