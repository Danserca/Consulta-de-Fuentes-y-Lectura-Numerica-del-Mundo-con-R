...
h1.title {
  color: #8B5F65; /* Azul claro - cambia a cualquier color que desees */
}
...
.navbar-default .navbar-nav > li > a {
  color: #5E5E5E; /* Cambia este valor para ajustar el color del texto en las etiquetas de las secciones */
}

/* Cambia el color del cintillo del menú lateral (toc) */
#toc {
  background-color: #8B3626; /* Color de fondo del menú lateral */
  border-color: #8B3626; /* Color del borde */
}

/* Cambia el color del texto en el menú lateral */
#toc .tocify-header, #toc .tocify-item {
  color: #8B5F65; /* Color del texto en las secciones del menú */
}

/* Cambia el color al pasar el ratón sobre los elementos del menú */
#toc .tocify-item:hover {
  color: #8B3626; /* Color del texto al pasar el ratón (dorado en este caso) */
}

/* Opcional: Cambia el color del fondo de las secciones del menú */
#toc .tocify-item.active {
  background-color: #4682B4; /* Azul acero para la sección activa */
}
</style>
...
| S1 L:  | 12 de agosto   | Introducción                          | Capítulo 1                      |
| S1 J:  | 15 de agosto   | Introducción a R y RStudio            | Capítulo 2                      |
| S2 L:  | 19 de agosto   | Introducción a R y RStudio            | Capítulo 2                      |
| S2 J:  | 22 de agosto   | Búsqueda de fuentes e informes con R Markdown     | Capítulo 3  [UNAM](https://docenciadigital.unam.mx/ayuda-busqueda#tip8)  [UNAM 2022](https://liec.dgb.unam.mx/index.php/investiga/la-busqueda-de-informacion)                   |
